...
import 'package:flutter_food/pages/FoodDetailsPage.dart';
...
class _PopularFoodsWidgetState extends State<PopularFoodsWidget> {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: SingleChildScrollView(  // Allow scrolling of the entire content
        child: Column(
          children: <Widget>[
                                ...
                                children: <Widget>[
                                  for (int i = 0; i < 5; i++)
                                    Icon(
                                      Icons.star,
                                      size: 10,
                                      color: i < double.parse(rating).round()
